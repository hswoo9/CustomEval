...
<div class="iframe_wrap" style="min-width:1400px">
	...
	<div class="right_div" style="height:70px;">
		<div class="controll_btn p10">
			...
			<button type="button" class="evalButton" id="saveButton" style="width: 120px; float: right; margin-left:10px; background-color: #dee4ea; border-color: black; border-width: thin;" onclick="saveBtn();">평가확정</button>
			...
			success : function(rs) {
				...
				for (var j = 0; j < compResult.length; j++) {
					...
					var remark = list.remark ? list.remark : '';
						...
						html += '<button type="button" class="evalButton" id="eachSaveButton" style="width: 170px; background-color: #dee4ea; border-color: black; border-width: thin;" onclick="eachSaveButton(' + compResult[j].eval_company_seq + ', \'' + companyRemarkList[j].DISPLAY_TITLE + '\');">' + companyRemarkList[j].DISPLAY_TITLE + ' 저장</button>';
