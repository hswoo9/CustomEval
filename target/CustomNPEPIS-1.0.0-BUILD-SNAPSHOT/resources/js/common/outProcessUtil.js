...
function outProcessLogOn(params){
	...
	var url = "http://211.237.50.199/gw/outProcessLogOn.do";
	if(location.host.indexOf("127.0.0.1") > -1 || location.host.indexOf("localhost") > -1){
    	form.prop("action", "http://211.237.50.199/gw/outProcessLogOn.do");
    }else{
...
function outProcessLogOn2(params){
	...
	if(location.host.indexOf("127.0.0.1") > -1 || location.host.indexOf("localhost") > -1){
		form.prop("action", "http://211.237.50.199/gw/outProcessLogOn.do");
		url  = "http://211.237.50.199/gw/outProcessLogOn.do";
    }else{
    	form.prop("action", "/gw/outProcessLogOn.do");
    	url  = "/gw/outProcessLogOn.do";
    }
...
function outProcessAppTest(data){
	var data = {};
	data.approKey = "tpfPurcRs12121";
	data.processId = "tpfPurcRs1";
	data.docId = "80";
	data.docSts = "90";
	data.userId = "admin";
	data.empSeq = "1";
	...
	data.compSeq = "1000";
    $.ajax({
		url: _g_contextPath_+"/purcReq/purcReqApp",
